...
def handle_demo_command(args) -> int:
    ...
    demo_text = """
# ESC/P2 Demo Document

## Text Formatting Examples
This document demonstrates the **ESC/P2 module** capabilities.

### Basic Formatting
- **Bold text** for emphasis
- __Underlined text__ for highlights  
- ``Inline code`` for technical terms
- ```Bold monospace``` for commands
...
|--------------|--------|-----------------|
| **Bold**     | 1      | Working         |
| ``Code``     | 2      | Monospace font  |
| __Underline__| 3      | ```Formatted``` |
| Tables       | 4      | Auto-sizing     |

### Code Block Example
Here's some example code:
```
def hello_world():
    print("Hello from ESC/P2!")
    return True
```
